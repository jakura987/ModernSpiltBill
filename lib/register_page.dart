...
class _RegisterFormState extends State<RegisterForm> {
  ...
  Future<void> _register() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      bool nameIsUnique =
          await isNameUnique(_preferredNameController.text.trim());
      if (!nameIsUnique) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('The name has been used by other accounts.')));
        return;
      }
          ...
          userCredential.user!.sendEmailVerification().then((value) {
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: Text(
                    'Thank you for registering! An email has been sent to your email address for verification. Please check and verify your account.'),
                actions: <Widget>[
                  TextButton(
                    child: Text('OK',
